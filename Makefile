...
PACKAGE ?= helm-opensearch
XRD_DIR := apis/opensearches
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/opensearches/standard.yaml
...
EXAMPLES := \
    examples/opensearches/minimal.yaml:: \
    examples/opensearches/standard.yaml::
...
render\:%:
	@example="examples/opensearches/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
